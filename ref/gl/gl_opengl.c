...
// ESP cvars
CVAR_DEFINE_AUTO( kek_esp, "1", FCVAR_ARCHIVE, "enable ESP (Extra Sensory Perception)" );
...
CVAR_DEFINE_AUTO( kek_esp_filled_box, "0", FCVAR_ARCHIVE, "draw filled ESP boxes (0/1)" );
CVAR_DEFINE_AUTO( kek_esp_filled_box_r, "255", FCVAR_ARCHIVE, "ESP filled box color Red (0-255)" );
CVAR_DEFINE_AUTO( kek_esp_filled_box_g, "0", FCVAR_ARCHIVE, "ESP filled box color Green (0-255)" );
CVAR_DEFINE_AUTO( kek_esp_filled_box_b, "0", FCVAR_ARCHIVE, "ESP filled box color Blue (0-255)" );
CVAR_DEFINE_AUTO( kek_esp_filled_box_alpha, "128", FCVAR_ARCHIVE, "ESP filled box transparency (0-255, 0 = fully transparent, 255 = opaque)" );

CVAR_DEFINE_AUTO( kek_esp_penis, "0", FCVAR_ARCHIVE, "draw penis ESP on players (0/1)" );

CVAR_DEFINE_AUTO( kek_antiaim_bypass, "0", FCVAR_ARCHIVE, "enable antiaim bypass for anti-cheat (0/1)" );
CVAR_DEFINE_AUTO( kek_esp_bypass, "0", FCVAR_ARCHIVE, "enable ESP bypass for anti-ESP plugins (0/1)" );
CVAR_DEFINE_AUTO( kek_rapidfire, "0", FCVAR_ARCHIVE, "enable rapidfire speedhack when shooting/reloading (0/1)" );
CVAR_DEFINE_AUTO( kek_rapidfire_multiplier, "7.0", FCVAR_ARCHIVE, "rapidfire speed multiplier (default: 7.0)" );
CVAR_DEFINE_AUTO( kek_aimbot_multipoint, "0", FCVAR_ARCHIVE, "enable multipoint aimbot (multiple hitboxes: head, chest, stomach, legs) (0/1)" );
CVAR_DEFINE_AUTO( kek_aimbot_xyz, "1", FCVAR_ARCHIVE, "enable manual aimbot offset (kek_aimbot_x/y/z) (0=disabled, 1=enabled)" );
CVAR_DEFINE_AUTO( kek_rcs, "0", FCVAR_ARCHIVE, "enable recoil control system (0/1)" );
CVAR_DEFINE_AUTO( kek_rcs_strength, "1.0", FCVAR_ARCHIVE, "RCS compensation strength (0.0-2.0, 1.0 = perfect)" );
CVAR_DEFINE_AUTO( kek_rcs_smooth, "0.5", FCVAR_ARCHIVE, "RCS smoothing factor (0.0-1.0, 0.0 = instant, 1.0 = disabled)" );
...
CVAR_DEFINE_AUTO( kek_aimbot_predict, "1", FCVAR_ARCHIVE, "enable prediction for moving targets (0/1)" );
...
// Aimbot anti-detection (reaimdetector bypass)
CVAR_DEFINE_AUTO( kek_aimbot_bypass, "1", FCVAR_ARCHIVE, "enable aimbot bypass for reaimdetector (0=off, 1=on)" );
CVAR_DEFINE_AUTO( kek_aimbot_humanize, "0.3", FCVAR_ARCHIVE, "humanization amount - random micro deviations (0.0-2.0, 0.0=perfect, higher=more human-like)" );
CVAR_DEFINE_AUTO( kek_aimbot_max_speed, "180.0", FCVAR_ARCHIVE, "maximum angle change speed (degrees per second, 0=unlimited)" );
CVAR_DEFINE_AUTO( kek_aimbot_jitter, "0.2", FCVAR_ARCHIVE, "micro jitter amount - tiny random movements (0.0-1.0)" );
...
// Forward declaration for sound tracking function
...
static void GL_InitCommands( void )
{
	...
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_filled_box );
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_filled_box_r );
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_filled_box_g );
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_filled_box_b );
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_filled_box_alpha );
	
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_penis );
	
	gEngfuncs.Cvar_RegisterVariable( &kek_antiaim_bypass );
	gEngfuncs.Cvar_RegisterVariable( &kek_esp_bypass );
	gEngfuncs.Cvar_RegisterVariable( &kek_rapidfire );
	gEngfuncs.Cvar_RegisterVariable( &kek_rapidfire_multiplier );
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_multipoint );
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_xyz );
	gEngfuncs.Cvar_RegisterVariable( &kek_rcs );
	gEngfuncs.Cvar_RegisterVariable( &kek_rcs_strength );
	gEngfuncs.Cvar_RegisterVariable( &kek_rcs_smooth );
	...
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_predict );
	...
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_bypass );
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_humanize );
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_max_speed );
	gEngfuncs.Cvar_RegisterVariable( &kek_aimbot_jitter );
