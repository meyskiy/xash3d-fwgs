...
// OpenGL function pointers - declared as extern here since they are defined in gl_context.c via gl_export.h
...
extern GLuint (APIENTRY *pglGenLists)(GLsizei range);
...
extern void (APIENTRY *pglPrioritizeTextures)(GLsizei n, const GLuint *textures, const GLclampf *priorities);
...
extern GLint (APIENTRY *pglRenderMode)(GLenum mode);
...
CVAR_DEFINE_AUTO( kek_antiaim_mode, "0", FCVAR_ARCHIVE, "antiaim mode (0=jitter, 1=spin, 2=fake, 3=backwards, 4=sideways, 5=legit, 6=fast spin, 7=random, 8=upside down)" );
